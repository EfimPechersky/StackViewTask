...
int QT_RCC_MANGLE_NAMESPACE(qInitResources_qmake_SwipeView_copy)();
int QT_RCC_MANGLE_NAMESPACE(qInitResources_qmake_SwipeView_copy)()
{
    int version = 3;
...
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_qmake_SwipeView_copy)();
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_qmake_SwipeView_copy)()
{
    int version = 3;
...
namespace {
   struct initializer {
       initializer() { QT_RCC_MANGLE_NAMESPACE(qInitResources_qmake_SwipeView_copy)(); }
       ~initializer() { QT_RCC_MANGLE_NAMESPACE(qCleanupResources_qmake_SwipeView_copy)(); }
   } dummy;
}
